...
import 'package:rentica/base/data/mock%20data/car_rental_list.dart' show carRentalList, favoriteCars, trendingCars;
...
class TrendingVehiclesScreen extends StatelessWidget {
  const TrendingVehiclesScreen({super.key});
